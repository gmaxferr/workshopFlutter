...
import 'package:workshopflutter/main.dart' as _i9;
import 'package:workshopflutter/note_list/bloc/note_edit_bloc.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singletonAsync<_i8.NoteEditBloc>(() async =>
        _i8.NoteEditBloc(noteListBloc: await getAsync<_i7.NoteListBloc>()));
    return this;
  }
}
